 ...
 *
 * Holds reduce-motion, high-contrast, and dyslexia settings.
 * Persists to localStorage under 'portfolio-a11y'. On each change it applies
...
export const useA11yStore = defineStore('a11y', () => {
  ...
  return { reduceMotion, highContrast, dyslexia, update }
})
